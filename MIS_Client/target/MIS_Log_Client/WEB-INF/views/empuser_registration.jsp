...
<div class="container" style="margin-top: 100px">
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body">
							<form action="empcreate" method="post" id="form1">
						<form id="accordion">
							<div class="form-row">
								...
								<div class="form-group col-md-6">
								  ...
								  <input type="text" class="form-control" name="emplName" id="emplName" placeholder="Employee Name" required>
								</div>
							...
							<div class="form-row">
								<div class="form-group col-md-6">
								  ...
								  <input type="Date" class="form-control" name="joinedDate" id="joinedDate" placeholder="Joined Date" required>
								</div>
								<div class="form-group col-md-6">
								  <label for="resignedDate">Resigned Date</label>
								  <input type="Date" class="form-control" name="resignedDate" id="resignedDate" placeholder="Resigned Date" required>
								</div>
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
								  <label for="activeFlag">Active Flag</label>
									<select class="form-control input-sm" name="activeFlag" id ="activeFlag" required>
			...
			<div class="text-center">
							 <button type="submit" form="form1" value="Submit" class="btn btn-success">Save</button>
							  ...
							  <a href="/MIS_Log_Client/emphome" style="color:white;text-decoration:none;">Cancel</a> </button>
